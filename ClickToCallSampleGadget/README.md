# Cisco Finesse - Click To Call Sample Gadget
The click to call sample gadget demonstrates how to place a call from an agent to another extension. It is intended to serve as an example of performing a make call to a preset phone number using the Dialog - Create a New Dialog (Make a Call) REST API.
...
## Usage
1. Read the document ClickToCall.pdf for an overview about this sample gadget as well as step-by-step instructions on how to build and upload your gadget.
