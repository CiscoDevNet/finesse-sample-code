# Cisco Finesse - Digital Channel Sample Gadget
The digital channel sample gadget is intended to serve as an example on
   how to use the digital channel APIs from the Finesse JavaScript library.
...
This sample gadget contains the following files:
	...
	FinesseJavaScriptLibrary/
	   readme.txt
	DigitalChannel/
         DigitalChannelGadget.xml
         DigitalChannelHandler.js
	_readme.txt
...
2. Edit layout xml in cfadmin to load the gadget
   <gadget>/3rdpartygadget/files/DigitalChannel/DigitalChannelGadget.xml</gadget>
