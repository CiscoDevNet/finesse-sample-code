...
4. An error message is shown in case the Save is not successful

Version 12.5.1-v1.0
![Sample Gadget Screenshot](EditCallVariables.png)
![Sample Gadget Screenshot](EditCallVariablesSave.png)
