# Cisco Finesse - Screen Pop Sample Gadget
The screen pop sample gadget provides a screen pop of a web page using data in a call variable associated with an inbound call. It is intended to serve as an example of popping a call variable (callvariable1) into an internet search. This sample illustrates how to initialize the gadget, set up handlers for user and dialog updates, and accessing callvariable1 of the dialog.
...
1. A value in callVariable1.

## Usage
1. Read the document ScreenPopSampleGadget.pdf for an overview about this sample gadget as well as step-by-step instructions on how to build and upload your gadget.
