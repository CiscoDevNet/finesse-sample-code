# Cisco Finesse - Tropo SMS Sample Gadget
The Tropo SMS sample gadget includes an agent and supervisor gadget. The agent gadget allows agents to send information to callers via SMS. The example gadget can store interaction history. The supervisor gadget is able to view the SMS history for the agents that are part of the teams they supervisor.
...
1. User must have a valid Tropo account that can send SMS.
