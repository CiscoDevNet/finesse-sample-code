...
The update call variable data sample gadget demonstrates how to call a Finesse REST API in a gadget. Most of the Finesse REST APIs have a matching JavaScript API, but the Update Call Variable Data REST API does not. It is intended to serve as an example of using the gadgets.io.makerequest function to make a REST API request.
...
1. A call where the call variable data can be updated.
